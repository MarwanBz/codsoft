...
navSlide();
// gsap.from("#home", { opacity: 0, duration: 0.8, delay: 0.8, ease: Power2.easeOut });
// gsap.to("#home", { opacity: 1, duration: 1, delay: 2, ease: Power2.easeOut });
